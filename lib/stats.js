import { cpuTemperature, processes as _processes, fsSize as _fsSize, networkStats as _networkStats, battery as _battery, mem, currentLoad } from 'systeminformation';
...
async function getNetworkStats() {
  try {
    const stats = await _networkStats();
